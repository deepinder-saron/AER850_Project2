'''AER850: Project 2 — Model 1 and Model 2 (96x96 Grayscale configration)
...
# However, to make the training process computationally efficient,
# we resize images to 96 x 96 while maintaining their essential features.
# The images are grayscale since color information is not important
# for identifying cracks, paint-off regions, or missing screws.

img_height = 96
img_width = 96
batch_size = 32  # Determines how many images are processed in one batch
epochs = 100      # Max number of times the model will go through the entire dataset (set to 20 to compare to the 500x500 RGB configuration)
...
train_generator = train_datagen.flow_from_directory(
    train_directory,
    target_size=(img_height, img_width),   # Resize to 96x96
    batch_size=batch_size,
    color_mode='grayscale',                # Grayscale input, all images are black and white
